          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 sticky top-[73px] z-40 py-2">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full md:w-auto">
              <TabsList className="bg-slate-200/50 border border-slate-200/50 p-1 h-12 rounded-2xl">
                <TabsTrigger value="converting" className="rounded-xl px-6 font-bold data-[state=active]:bg-white data-[state=active]:text-primary data-[state=active]:shadow-sm transition-all text-xs">
                  <ListMusic className="w-3.5 h-3.5 mr-2" />
                  QUEUE {pendingFiles.length > 0 && <span className="ml-1 opacity-50">({pendingFiles.length})</span>}
                </TabsTrigger>
                <TabsTrigger value="history" className="rounded-xl px-6 font-bold data-[state=active]:bg-white data-[state=active]:text-primary data-[state=active]:shadow-sm transition-all text-xs">

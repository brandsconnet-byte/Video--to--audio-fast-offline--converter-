...
export function UploadZone({ onFilesSelect }: UploadZoneProps) {
  ...
  return (
    <div 
      className="group relative h-48 md:h-56 w-full rounded-[2.5rem] bg-white border-2 border-dashed border-slate-200 hover:border-primary/40 hover:bg-slate-50 transition-all cursor-pointer overflow-hidden flex flex-col items-center justify-center gap-5 shadow-sm"
